...
namespace allSdk
{
    ...
    /// author chenshuai
    /// $Id$
    /// Create time:2014/6/16 10:22:42 
    /// </summary>
    ///
    public class AndroidWandoujia:IPlatform
    {
        ...
        public void setPayParameter(string tradeNo, string price, string desc)
        {
        ...
        public void pay()
        {
            object[] parameter = new object[] { desc,price,tradeNo };
