...
namespace allSdk
{
    ...
    /// author chenshuai
    /// $Id$
    /// Create time:2014/6/24 11:58:29 
    /// </summary>
    ///
    public class AndroidFeiliu:IPlatform
    {
        ...
        /// <param name="merpriv">透传参数</param>
        public void setPayParameter(string gameName, int amount, string cporderid, string describe, string merpriv = "")
        {
        ...
        public void pay()
        {
            object[] parameter = new object[]{this.gameName,this.amount,this.cporderid,this.describe,this.merpriv};
