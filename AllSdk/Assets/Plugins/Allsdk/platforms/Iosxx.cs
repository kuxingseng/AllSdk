...
namespace allSdk
{
    ...
    public class IosXX:IPlatform
    {
        ...
        /// <param name="itemID">商品ID（自定义）</param>
        /// <param name="itemName">商品名称</param>
        /// <param name="itemPrice">商品价格</param>
        /// <param name="itemCount">商品数量</param>
        /// <param name="reserved">透传字段，原样返回服务端</param>
		public void setPayParameter(string orderId, string itemID, string itemName,string itemPrice, string itemCount, string reserved)
        {
        ...
        /// 平台类型
        /// </summary>
		public string type { get{return PlatformNameEnum.IOS_XX.ToString();} }
